## this script is a slight modification of the primary_transcript.py file included
## in the 2.3.12 version of Orthofinder
...
def main(args=None):
    if args is None:
        args = sys.argv[1:]
    fn = args[0]
    dout = os.path.dirname(os.path.abspath(fn)) + "/longest_isoforms/"
