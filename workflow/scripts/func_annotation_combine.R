...
#also only do this if AHRD was run for at least one species
if (length(ahrd_files) > 0) {
...
#and also only do this if user supplied at least one file this way
if (length(renamed_user_files) > 0) {
