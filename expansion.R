...
print("Acquiring hypothesis variables:")
...
print("Reading in Orthogroup-GeneCounts-table:")
...
print("Applying expansion rule/s per hypothesis:")
expanded_OGs <- OG.GC
...
print("Concatenating all BLAST seaches to one file and creating parseable tibble:")
datalist = list()
...
print("Reading in conversion table based on SequenceIDs.txt:")
...
print("Creating reformatted output with actual gene/protein names:")
...
print("Reading in Orthogroups.txt:")
...
print("Creating .txt files for all expanded OGs with reciprocal best BLAST hits of species in respective hypothesis:")
...
print("Expansion successfully computed - creating .check:")
